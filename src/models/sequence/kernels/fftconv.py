...
class FFTConv(SequenceModule):
    ...
    def forward(self, x, state=None, rate=1.0, **kwargs): # absorbs return_output and transformer src mask
        ...
        # print('A shape :', self.kernel._get_params()[1].shape)
        # print('A :', self.kernel._get_params()[1][0])
        # print('A :', self.kernel._get_params()[1][1])
        # print('A :', self.kernel._get_params()[1][2])
